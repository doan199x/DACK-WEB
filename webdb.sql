...
insert into Student (name,email,password,avatarPath,balance) values('Trần Hoàng Cường','cuonghoang1213@gmail.com','123456','/public/images/avatar/student1.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Nguyễn Thị Hạ','hanguyen45451@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Hoàng Công Ẩn','anhoang11235@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Đỗ Thị Liễu','nguyenlieu55151@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Lý Thị Mai','maily2545151@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Nguyễn Công Hưởng','huongcongnguyen@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Nguyễn Nhật Nam','namnhat124566@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Đào Bá Quang','quangba54545@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Hà Huy Lợi','loaihuy124510@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Nguyễn Hoàng Tín','hoangtin1508@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Phạn Huy Ích','huyich@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Lý Thị Thủy','thuylty111213@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Đào Bá Nhật','banhat1678@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Đinh Lan Hương','huonglan@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Nguyễn Đình Cảnh','canhdinh55689@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Lã Văn Cà','cala121551@gmail.com','123456','/public/images/avatar/default.jpg',100000);
insert into Student (name,email,password,avatarPath,balance) values('Đương Văn Hoàng','hoangduong5415151@gmail.com','123456','/public/images/avatar/default.jpg',100000);
...
insert into Course (name,imagePath,sortDescription,description,NoStudents,averageStar,price,lastUpdated,categoryID,status,teacherID) 
values('Lập trình Android căn bản','/public/images/course/default.jpg','Khóa học làm quen với lập trình Android','Khóa học làm quen với lập trình Android Khóa học làm quen với lập trình Android',100,5,50000,now(),2,'Đã hoàn tất',1);
insert into Course (name,imagePath,sortDescription,description,NoStudents,averageStar,price,lastUpdated,categoryID,status,teacherID) 
values('Lập trình Android nâng cao','/public/images/course/default.jpg','Lập trình Android nâng cao','Lập trình Android nâng cao Lập trình Android nâng cao',200,5,50000,now(),2,'Đã hoàn tất',1);
insert into Course (name,imagePath,sortDescription,description,NoStudents,averageStar,price,lastUpdated,categoryID,status,teacherID) 
values('Lập trình IOS căn bản','/public/images/course/default.jpg','Làm quen với lập trình IOS','Giúp hiểu các khái niệm cơ bản về IOS',100,5,100000,now(),2,'Đã hoàn tất',1);
insert into Course (name,imagePath,sortDescription,description,NoStudents,averageStar,price,lastUpdated,categoryID,status,teacherID) 
values('Lập trình IOS nâng cao','/public/images/course/default.jpg','Học về IOS nâng cao','Tiếp cận các khái niệm nâng cao về ios',100,5,100000,now(),2,'Đã hoàn tất',1);
insert into Course (name,imagePath,sortDescription,description,NoStudents,averageStar,price,lastUpdated,categoryID,status,teacherID) 
values('Lập trình Nodejs cho người mới bắt đầu','/public/images/course/default.jpg','Khóa học làm quen với lập trình NodeJS','giúp hiểu các khái niệm cơ bản trong Nodejs',256,4.6,150000,now(),1,'Đã hoàn tất',1);
insert into Course (name,imagePath,sortDescription,description,NoStudents,averageStar,price,lastUpdated,categoryID,status,teacherID) 
values('Lập trình Nodejs nâng cao','/public/images/course/default.jpg','Khóa học làm quen với lập trình Android','Khóa học làm quen với lập trình Android Khóa học làm quen với lập trình Android',512,3.8,150000,now(),2,'Đã hoàn tất',1);
insert into Course (name,imagePath,sortDescription,description,NoStudents,averageStar,price,lastUpdated,categoryID,status,teacherID) 
values('Cùng học Python','/public/images/course/default.jpg','Khóa học làm quen với lập trình Python căn bản','Giúp hiểu rõ các khái niệm căn bản trong python',631,2.1,200000,now(),2,'Đã hoàn tất',1);
insert into Course (name,imagePath,sortDescription,description,NoStudents,averageStar,price,lastUpdated,categoryID,status,teacherID) 
values('Python cho mọi người','/public/images/course/default.jpg','Lập trình python căn bản','Học cách lập trình python căn bản',521,4.8,200000,now(),2,'Đã hoàn tất',1);
insert into Course (name,imagePath,sortDescription,description,NoStudents,averageStar,price,lastUpdated,categoryID,status,teacherID) 
values('Lập trình ASP.NET','/public/images/course/default.jpg','Làm quen với ASP.NET','Khóa học dnahf cho người mới bắt đầu',215,4.5,250000,now(),2,'Đã hoàn tất',1);
insert into Course (name,imagePath,sortDescription,description,NoStudents,averageStar,price,lastUpdated,categoryID,status,teacherID) 
values('Lập trình Xamarin','/public/images/course/default.jpg','Giúp lập trình Xamarin','Khóa học ngắn hạn',5612,1.6,250000,now(),1,'Đã hoàn tất',1);
